...
A token is a means of identifying a user that has already been granted access to a service,
it is an encrypted key that is unique to the service provider and can only be generated by
the service provider
- [x] What steps can you take in your web apps to keep your data secure?
Password protection
Layers of Authentication
HTTP requests Signing
- [x] Describe how web servers work.
Web servers receive web requests from clients which are usually PCs, they decode the requests, 
run verifications if necessary and pass the results back to the client
